...
save(rawdata_combined, rawdata_combined_RUVg, rawdata_combined_RUVs, rawdata_combined_ComBat, 
     ...
     group, batch, file = "GEO_after.Rdata")
```
...
export_DE_genes <- function(Data) {
  ...
  csv_filename_up <- paste("GEO_up-regulate(", data_name, ").csv", sep = "")
  ...
  csv_filename_down <- paste("GEO_down-regulate(", data_name, ").csv", sep = "")
...
generate_heatmap <- function(Data, xdata, group, batch) {
  ...
  colnames(xdata) <- gsub("Series1_NHBE_Mock_1", "GSE147507_Normal_1", colnames(xdata))
  colnames(xdata) <- gsub("Series1_NHBE_Mock_2", "GSE147507_Normal_2", colnames(xdata))
  colnames(xdata) <- gsub("Series1_NHBE_Mock_3", "GSE147507_Normal_3", colnames(xdata))
  colnames(xdata) <- gsub("Series1_NHBE_SARS.CoV.2_1", "GSE147507_SARS.CoV.2_1", colnames(xdata))
  colnames(xdata) <- gsub("Series1_NHBE_SARS.CoV.2_2", "GSE147507_SARS.CoV.2_2", colnames(xdata))
  colnames(xdata) <- gsub("Series1_NHBE_SARS.CoV.2_3", "GSE147507_SARS.CoV.2_3", colnames(xdata))
  colnames(xdata) <- gsub("X.N.dc2.projects.ngs.users.edrsimps.CMG_projects.NS_181.ILMN_748_Gaston_mRNAseq6_May2020.STARmapping_hg38.G1_Treatment_S4.G1_Treatment_S4_Aligned.sortedByCoord.out.bam", "GSE150962_SARS.CoV.2_1", colnames(xdata))
  colnames(xdata) <- gsub("X.N.dc2.projects.ngs.users.edrsimps.CMG_projects.NS_181.ILMN_748_Gaston_mRNAseq6_May2020.STARmapping_hg38.G2_Treatment_S5.G2_Treatment_S5_Aligned.sortedByCoord.out.bam", "GSE150962_SARS.CoV.2_2", colnames(xdata))
  colnames(xdata) <- gsub("X.N.dc2.projects.ngs.users.edrsimps.CMG_projects.NS_181.ILMN_748_Gaston_mRNAseq6_May2020.STARmapping_hg38.G3_Treatment_S6.G3_Treatment_S6_Aligned.sortedByCoord.out.bam", "GSE150962_SARS.CoV.2_3", colnames(xdata))
  colnames(xdata) <- gsub("X.N.dc2.projects.ngs.users.edrsimps.CMG_projects.NS_181.ILMN_748_Gaston_mRNAseq6_May2020.STARmapping_hg38.P1_Control_S1.P1_Control_S1_Aligned.sortedByCoord.out.bam", "GSE150962_Normal_1", colnames(xdata))
  colnames(xdata) <- gsub("X.N.dc2.projects.ngs.users.edrsimps.CMG_projects.NS_181.ILMN_748_Gaston_mRNAseq6_May2020.STARmapping_hg38.P2_Control_S2.P2_Control_S2_Aligned.sortedByCoord.out.bam", "GSE150962_Normal_2", colnames(xdata))
  colnames(xdata) <- gsub("X.N.dc2.projects.ngs.users.edrsimps.CMG_projects.NS_181.ILMN_748_Gaston_mRNAseq6_May2020.STARmapping_hg38.P3_Control_S3.P3_Control_S3_Aligned.sortedByCoord.out.bam", "GSE150962_Normal_3", colnames(xdata))
  ...
  pheatmap(gene_expression_matrix[top_genes, ],
           ...
           main = title, 
           filename = paste0("GEO_Heatmap(", data_name, ").png"))
}
...
perform_GO_enrichment_analysis <- function(Data) {
  ...
  ggsave(paste0("GEO_GO_bubble_plot(", data_name, ").png"), plot = plot, width = 10, height = 6, units = "in")
}
